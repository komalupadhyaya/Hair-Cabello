...
const MemberLayout = ({ children }: MemberLayoutProps) => {
    ...
    const StatusCard = () => (
        <div className="bg-slate-900 rounded-2xl p-4 text-white relative overflow-hidden mb-2 shadow-xl shadow-blue-900/20">
            <Sparkles className="h-12 w-12 text-blue-500/20 absolute -right-2 -bottom-2" />
            <p className="text-[10px] font-black text-blue-400 uppercase tracking-widest mb-1">Hair Portfolio</p>
            <p className="text-sm font-black italic tracking-tighter">Premium Member</p>
        </div>
    );
